...
export default function About() {
  ...
  return (
    <section id="about" className="relative py-24 md:py-36 bg-zinc-950 text-white overflow-hidden border-t border-zinc-900">
      {/* Decorative vertical lines and absolute items */}
      <div className="absolute right-0 top-0 w-1/3 h-full border-l border-zinc-900/40 pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="max-w-3xl mb-16 md:mb-24" data-aos="fade-up">
          ...
          <div className="w-20 h-[1px] bg-white mt-8" />
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 p-8 md:p-12 bg-black border border-zinc-900 relative" data-aos="fade-right">
            ...
            <p className="font-script text-3xl md:text-4xl lg:text-5xl text-zinc-300 leading-relaxed pt-6">
              Baking is not just a recipe; it is an intimate expression of luxury, design, and unforgettable sensation.
            </p>
            <div className="mt-8 flex justify-end">
              <span className="font-sans text-[10px] tracking-widest uppercase text-zinc-500 font-semibold">
          ...
          <div className="lg:col-span-7 flex flex-col justify-between h-full space-y-6 md:space-y-8" data-aos="fade-left">
            ...
            <p className="font-sans text-sm md:text-base text-zinc-400 font-light leading-relaxed tracking-wide">
              Founded on the belief that desserts should be a multisensory experience, Cristin Luscious began as a boutique studio dedicated to pushing the boundaries of classic baking. Our hallmark is a sophisticated monochrome visual philosophy, allowing the rich textures, exquisite geometries, and deep flavor notes of our creations to take absolute center stage.
            </p>

            <p className="font-sans text-sm md:text-base text-zinc-400 font-light leading-relaxed tracking-wide">
              From our crispy-edge artisan cookies to our legendary velvety signature cheesecake, every item in our menu is a celebration of taste and culinary elegance. We reject mass production in favor of small-batch perfection, ensuring that every box delivered is an experience of supreme luxury.
            </p>

            {/* Micro Stats counters */}
            <div className="grid grid-cols-2 md:grid-cols-3 gap-6 pt-6 border-t border-zinc-900">
              <div>
                <p className="font-playfair text-3xl md:text-4xl font-bold text-white">100%</p>
                <p className="text-[10px] tracking-widest uppercase text-zinc-500 mt-1">Artisan Handcrafted</p>
              </div>
              <div>
                <p className="font-playfair text-3xl md:text-4xl font-bold text-white">Zero</p>
                <p className="text-[10px] tracking-widest uppercase text-zinc-500 mt-1">Compromise on Taste</p>
              </div>
              <div className="col-span-2 md:col-span-1">
                <p className="font-playfair text-3xl md:text-4xl font-bold text-white">Premium</p>
                <p className="text-[10px] tracking-widest uppercase text-zinc-500 mt-1">Imported Ingredients</p>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-20 md:mt-32">
          {values.map((value, idx) => (
            ...
            >
              ...
              <h4 className="font-playfair text-lg text-white font-semibold mb-3 tracking-wide">
                {value.title}
              </h4>
