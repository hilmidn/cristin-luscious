...
export default function About() {
  const values = [
    ...
    {
      icon: <Award size={22} className="text-brand-dark" />,
    ...
    {
      icon: <ShieldCheck size={22} className="text-brand-dark" />,
  ...
  return (
    <section id="about" className="relative py-24 md:py-36 bg-brand-bg text-brand-dark overflow-hidden border-t border-brand-border">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="max-w-3xl mb-16 md:mb-24" data-aos="fade-up">
          ...
          <div className="w-20 h-[1px] bg-brand-dark mt-8" />
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 p-8 md:p-12 bg-brand-card border border-brand-border relative" data-aos="fade-right">
          ...
          <div className="lg:col-span-7 flex flex-col justify-between h-full space-y-6 md:space-y-8" data-aos="fade-left">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-6 pt-6 border-t border-brand-border">
              <div>
                <p className="font-playfair text-3xl md:text-4xl font-bold text-brand-dark">100%</p>
                <p className="text-[10px] tracking-widest uppercase text-brand-text mt-1">Artisan Handcrafted</p>
              </div>
              <div>
                <p className="font-playfair text-3xl md:text-4xl font-bold text-brand-dark">Zero</p>
                <p className="text-[10px] tracking-widest uppercase text-brand-text mt-1">Compromise on Taste</p>
              </div>
              <div className="col-span-2 md:col-span-1">
                <p className="font-playfair text-3xl md:text-4xl font-bold text-brand-dark">Premium</p>
                <p className="text-[10px] tracking-widest uppercase text-brand-text mt-1">Imported Ingredients</p>
              </div>
            </div>
