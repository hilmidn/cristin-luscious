        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 relative w-full aspect-square md:aspect-[4/3] lg:aspect-square" data-aos="fade-right">
            ...
            <div className="relative w-full h-full overflow-hidden border border-brand-border group bg-brand-card">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-tr from-brand-dark/20 via-transparent to-transparent opacity-45" />
          ...
          <div className="lg:col-span-6 flex flex-col space-y-6 lg:space-y-8" data-aos="fade-left">
            <div>
              ...
              <div className="w-16 h-[1px] bg-brand-border mt-6" />
            </div>
            ...
            <div className="pt-6 border-t border-brand-border flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6" data-aos="fade-up" data-aos-delay="400">
              <div>
                <p className="text-[10px] tracking-widest uppercase text-brand-text">Starting From</p>
                <p className="font-playfair text-2xl md:text-3xl font-bold text-brand-dark mt-1">IDR 350.000</p>
              </div>
              <a
                href="#contact"
